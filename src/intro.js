...
export default class Intro extends Component {
  ...
  render(){
    ...
    <div className='inner flex-column'>
        <p>
          Full stack developer here, I enjoy everything from creating performance oriented React components to designing database schemas with PostgreSQL for microservices. I build this website myself, with no external libraries of frameworks (except React), no Wordpress plugin here. I love learning! Challenges that demand serious thinking and invite trying new ideas are a YES in my book. I don’t shy away from big problems, and I do what it takes to get the job done well. I yearn for quality and perfection in my work. I will stay up through the night to something the right way rather than just "getting it done". My driving philosophy when coding is to write for the next developer and continually make business minded decisions.
        </p>
